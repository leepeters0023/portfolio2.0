  ...
  render() {
    return (
      <div id='web-dev-container'>
        <div id='web-dev'>
        <img id='baf453d4db5947d5b653480175c4c934' alt='twinthread-pricing-thumb' className='webdev-thumb' onClick={this.openModal} src='Images/twinthreadPricing.png'></img>
