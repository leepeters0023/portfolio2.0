    ...
    <div id="home-main">
      <div id="home-landing">
        ...
        <div id="home-portrait">
          <a id="home-portrait-desktop" href="https://imgur.com/jcWzmNS">
            <img
              src="https://i.imgur.com/jcWzmNS.png?2"
      ...
      <div id="home-about">
        <h2>I'm Lee</h2>
        <p id="about-p">
          Thanks for stopping by. I’m a front end web developer specializing in
          bespoke, single origin, grass fed, gluten free, and slow roasted apps
          and websites.<br></br>
